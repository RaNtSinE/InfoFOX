function loadProfile() {
                        ...
                        React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    'input',
                                    {
                                        className: "form-control OldPassword", type: "password", name: "OldPassword",
                                ...
                                React.createElement(
                                    'input',
                                    {
                                        className: "form-control NewPassword", type: "password", name: "NewPassword",
                                ...
                                React.createElement(
                                    'input',
                                    {
                                        className: "form-control RepeatPassword", type: "password", name: "RepeatPassword",
        ...
        class ProfileBlocks extends React.Component {
            ...
            render() {
                return React.createElement(
                    ...
                    React.createElement(
                        'input',
                        {type: "text", className: "profile_name", defaultValue: this.props.Name, maxLength: "60"},
                    )
                );
            }
        }
    ...
    function bracDelete() {
        let bracelets = document.getElementsByClassName('profileFrame__braceletBlock');
